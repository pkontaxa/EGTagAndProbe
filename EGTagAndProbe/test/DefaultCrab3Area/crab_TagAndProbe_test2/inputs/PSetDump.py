...
process.hltFilter = cms.EDFilter("HLTHighLevel",
    HLTPaths = cms.vstring('HLT_Ele27_WPTight_Gsf_v'),
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('90X_mcRun2_asymptotic_v0'),
...
process.NtupleSeq = cms.Sequence(process.Ntuplizer)
...
process.p = cms.Path(process.electrons+process.NtupleSeq)
